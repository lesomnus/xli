...
func (IntParser) Parse(rest []string) (int, int, error) {
...
func (Int32Parser) Parse(rest []string) (int32, int, error) {
...
func (Int64Parser) Parse(rest []string) (int64, int, error) {
	v, err := strconv.ParseInt(rest[0], 10, 64)
...
func (UintParser) Parse(rest []string) (uint, int, error) {
...
func (Uint32Parser) Parse(rest []string) (uint32, int, error) {
...
func (Uint64Parser) Parse(rest []string) (uint64, int, error) {
	v, err := strconv.ParseUint(rest[0], 10, 64)
